...
import numpy as np
df = pd.read_csv("../../data/input_files/figure_datasets/Supplementary_5_roc_results_glide.csv",sep=';')
...
# Generate the husl color palette with the number of groups
husl_colors = sns.color_palette("husl", len(groups))

# Manually set the colors
colors = husl_colors.copy()  # Copy the husl colors to modify them
colors[1] = 'wheat'  # Set the color for the second group to 'wheat'
